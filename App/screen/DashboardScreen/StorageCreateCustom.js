...
const StorageCreateCustom = props => {
  ...
  useEffect(() => {
    PrefManager.getValue('@bag_ID');
    setSelectedIndex(bag_type - 1);
  ...
  const callUsingBagID = async (orderID, id) => {
    var data = {
      ...
      bag_weight: selected ? selected : 0,
      baglocation: 0,
      forceugly: selectedIndex === 0 ? 1 : '',
      redeliver: bag_Name === 'identify' ? 'I' : 'M',
      newstatus: bag_Name === 'goldcare' ? 4 : bag_Name === 'transit' ? 3 : 2,
      order_id: orderID,
      savethis: 1,
    };
      ...
      <LinearGradient
        ...
        <View style={{width: '100%', backgroundColor: Colors.white}}>
          <SelectList
            ...
            placeholder={selected === undefined ? 0 + 'Kg' : selected + 'Kg'}
          />
          ...
          <View style={{marginTop: 10}}>
            <View
              ...
              <Button
                ...
                onPress={() => {
                  // console.log(
                  //   'SELECTEDINDEX=> ' + JSON.stringify(selectedIndex),
                  // );
                  selectedIndex !== null || ''
